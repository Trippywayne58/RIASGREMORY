...
module.exports = {
  ...
  caption: process.env.CAPTION || "𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬 𝕯𝖈𝖞𝖔𝖚𝖓𝖌𝖋𝖑𝖞",
  author: process.env.PACK_AUTHER || "𝕯𝖛",
  packname: process.env.PACK_NAME || "𝗥𝗜𝗔𝗦 𝗠𝗗",
  botname: process.env.BOT_NAME || "𝕯𝖈𝖞𝖔𝖚𝖓𝖌𝖋𝖑𝖞",
  ownername: process.env.OWNER_NAME || "𝕯𝖈𝖞𝖔𝖚𝖓𝖌𝖋𝖑𝖞",
